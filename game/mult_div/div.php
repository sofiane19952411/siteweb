...
<!--profile-->
 ...
 <input type="hidden"  id="type" value="<?=$gh;?>"/>
    ...
    <a href="div_home.php" class="restart" id="restart2" ></a>
    <a href="../profile2.php" class="home" id="home"> </a>
    
    <!--troisième  page-->
    <form action="" method="post" id="form">
<input type="hidden" name="scoredivfacile" id="scoref"  />
<input   type="hidden" name="scoredivdifficile" id="scored"  />
...
<button  name="score" class="restart" id="restart" hidden/> </button>
    ...
    <div class="container2" id="container2" >
        <h1 class="title2" id="x">Division</h1>
        <div class="game-container2" id="game-container2">
            <div class="grid-container2">
                <div class="grid-row2">
                    <div class="grid-cell2" id="a1" onclick="div(this.value)">1</div>
                    <div class="grid-cell2" id="a2" onclick="div(this.value)">2</div>
                    <div class="grid-cell2" id="a3" onclick="div(this.value)">3</div>
                </div>
                <div class="grid-row2">
                    <div class="grid-cell2" id="a4" onclick="div(this.value)">4</div>
                    <div class="grid-cell2" id="a5" onclick="div(this.value)">5</div>
                    <div class="grid-cell2" id="a6" onclick="div(this.value)">6</div>
                </div>
                <div class="grid-row2">
                    <div class="grid-cell2" id="a7" onclick="div(this.value)">7</div>
                    <div class="grid-cell2" id="a8" onclick="div(this.value)">8</div>
                    <div class="grid-cell2" id="a9" onclick="div(this.value)">9</div>
                </div>
