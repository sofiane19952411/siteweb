...
<body id="body"><br><br><br><br>
    ...
    <!--premier page-->
    <div id="page3">
        <h1 class="md">Division</h1>
        <h1 class="h">Choisir le niveau pour jouer</h1>
        <div class="grid-row3">
             <a href="div.php?id=facile">  <div class="grid-cell3 pic1" onclick="difficile()" onmouseover="function1()" onmouseout="f1()"   id="pic1"></div></a>
           <a href="div.php?id=dificile"> <div class="grid-cell3 pic1" onclick="facile()" onmouseover="function2()" onmouseout="f1()"  id="pic2"> </div></a>
