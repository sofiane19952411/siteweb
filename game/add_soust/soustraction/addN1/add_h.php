...
<!-- /form register scor -->
  ...
  <h1 class="title1" id="x1" ></h1><br> <br>
   ...
   <div><img src="nh.gif"  class="nh" id="nh"></img></div>
   <div class="score_po">
...
<div class="game-container" id="game">
 ...
 <div class="grid-container" id="fg">
    ...
    <div class="sui">
    <a href="../addN4/add_h.php"  id="previous" class="prev">&laquo; Previous</a>
    <a href="../addN2/add_h.php" id="next"  class="prev">Next &raquo;</a>
    </div>
