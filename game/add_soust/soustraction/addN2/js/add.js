...
function charge() {
   ...
   document.getElementById("game").style.backgroundImage='url(f.jpg)';
  ...
  RR1= return_v1();
      ...
      document.getElementById("x").innerHTML="X<sup>?</sup> -"+RR1[1]+" = "+RR1[0];
...
{ 
   ...
   if(index_v<29)
   {
        index_v =index_v + 1;
        RR1=return_v1();
        document.getElementById("x").innerHTML="A<sup>?</sup> -"+RR1[1]+" = "+RR1[0];
        document.getElementById('x1').innerHTML = "Bravo !";
        setTimeout(function() {document.getElementById('x1').innerHTML = "";},1000);
